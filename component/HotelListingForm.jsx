...
const HotelListingForm = ({ navigation }) => {
  ...
  const titleOptions = [
  "1 Bedroom short-let in Abuja",
  "1 Bedroom short-let in Aba",
  "1 Bedroom short-let in Lagos",
  "1 Bedroom short-let in Kano",
  "1 Bedroom short-let in Ibadan",
  "1 Bedroom short-let in Port Harcourt",
  "1 Bedroom short-let in Enugu",
  "1 Bedroom short-let in Benin City",
  "1 Bedroom short-let in Owerri",
  "1 Bedroom short-let in Asaba",
  "1 Bedroom short-let in Jos",
  "1 Bedroom short-let in Maiduguri",
  "1 Bedroom short-let in Kaduna",
  "1 Bedroom short-let in Ilorin",
  "1 Bedroom short-let in Yola",
  "1 Bedroom short-let in Akure",
  "1 Bedroom short-let in Ado-Ekiti",
  "1 Bedroom short-let in Calabar",
  "1 Bedroom short-let in Sokoto",
  "1 Bedroom short-let in Uyo",
  "1 Bedroom short-let in Bauchi",
  "1 Bedroom short-let in Jalingo",
  "1 Bedroom short-let in Lokoja",
  "1 Bedroom short-let in Makurdi",
  "1 Bedroom short-let in Yenagoa",
  "1 Bedroom short-let in Minna",
  "1 Bedroom short-let in Birnin Kebbi",
  "1 Bedroom short-let in Gombe",
  "1 Bedroom short-let in Damaturu",
  "1 Bedroom short-let in Bida",
  "1 Bedroom short-let in Abakaliki",
  "1 Bedroom short-let in Abeokuta",
  "1 Bedroom short-let in Awka",
  "1 Bedroom short-let in Bwari",
  "1 Bedroom short-let in Katsina",
  "1 Bedroom short-let Ikeja",

  // 2 Bedroom short-let for all capitals
  "2 Bedroom short-let in Abuja",
  "2 Bedroom short-let in Aba",
  "2 Bedroom short-let in Lagos",
  "2 Bedroom short-let in Kano",
  "2 Bedroom short-let in Ibadan",
  "2 Bedroom short-let in Port Harcourt",
  "2 Bedroom short-let in Enugu",
  "2 Bedroom short-let in Benin City",
  "2 Bedroom short-let in Owerri",
  "2 Bedroom short-let in Asaba",
  "2 Bedroom short-let in Jos",
  "2 Bedroom short-let in Maiduguri",
  "2 Bedroom short-let Kaduna",
  "2 Bedroom short-let in Ilorin",
  "2 Bedroom short-let in Yola",
  "2 Bedroom short-let in Akure",
  "2 Bedroom short-let in Ado-Ekiti",
  "2 Bedroom short-let in Calabar",
  "2 Bedroom short-let in Sokoto",
  "2 Bedroom short-let in Uyo",
  "2 Bedroom short-let in Bauchi",
  "2 Bedroom short-let in Jalingo",
  "2 Bedroom short-let in Lokoja",
  "2 Bedroom short-let in Makurdi",
  "2 Bedroom short-let in Yenagoa",
  "2 Bedroom short-let in Minna",
  "2 Bedroom short-let in Birnin Kebbi",
  "2 Bedroom short-let in Gombe",
  "2 Bedroom short-let in Damaturu",
  "2 Bedroom short-let in Bida",
  "2 Bedroom short-let in Abakaliki",
  "2 Bedroom short-let in Abeokuta",
  "2 Bedroom short-let in Awka",
  "2 Bedroom short-let in Bwari",
  "2 Bedroom short-let in Katsina",
  "2 Bedroom short-let in Ikeja",

  // 3 Bedroom short-let for all capitals
  "3 Bedroom short-let in Aba",
  "3 Bedroom short-let in Abuja",
  "3 Bedroom short-let in Lagos",
  "3 Bedroom short-let in Kano",
  "3 Bedroom short-let in Ibadan",
  "3 Bedroom short-let in Port Harcourt",
  "3 Bedroom short-let in Enugu",
  "3 Bedroom short-let in Benin City",
  "3 Bedroom short-let in Owerri",
  "3 Bedroom short-let in Asaba",
  "3 Bedroom short-let in Jos",
  "3 Bedroom short-let in Maiduguri",
  "3 Bedroom short-let in Kaduna",
  "3 Bedroom short-let in Ilorin",
  "3 Bedroom short-let in Yola",
  "3 Bedroom short-let in Akure",
  "3 Bedroom short-let in Ado-Ekiti",
  "3 Bedroom short-let in Calabar",
  "3 Bedroom short-let in Sokoto",
  "3 Bedroom short-let in Uyo",
  "3 Bedroom short-let in Bauchi",
  "3 Bedroom short-let in Jalingo",
  "3 Bedroom short-let in Lokoja",
  "3 Bedroom short-let in Makurdi",
  "3 Bedroom short-let in Yenagoa",
  "3 Bedroom short-let in Minna",
  "3 Bedroom short-let in Birnin Kebbi",
  "3 Bedroom short-let in Gombe",
  "3 Bedroom short-let in Damaturu",
  "3 Bedroom short-let in Bida",
  "3 Bedroom short-let in Abakaliki",
  "3 Bedroom short-let in Abeokuta",
  "3 Bedroom short-let in Awka",
  "3 Bedroom short-let in Bwari",
  "3 Bedroom short-let in Katsina",
  "3 Bedroom short-let in Ikeja",

  // Studio short-let for all capitals
  "Studio short-let in Abuja",
  "Studio short-let in Lagos",
  "Studio short-let in Kano",
  "Studio short-let in Ibadan",
  "Studio short-let in Port Harcourt",
  "Studio short-let in Enugu",
  "Studio short-let in Benin City",
  "Studio short-let in Owerri",
  "Studio short-let in Asaba",
  "Studio short-let in Jos",
  "Studio short-let in Maiduguri",
  "Studio short-let in Kaduna",
  "Studio short-let in Ilorin",
  "Studio short-let in Yola",
  "Studio short-let in Akure",
  "Studio short-let in Ado-Ekiti",
  "Studio short-let in Calabar",
  "Studio short-let in Sokoto",
  "Studio short-let in Uyo",
  "Studio short-let in Bauchi",
  "Studio short-let in Jalingo",
  "Studio short-let in Lokoja",
  "Studio short-let in Makurdi",
  "Studio short-let in Yenagoa",
  "Studio short-let in Minna",
  "Studio short-let in Birnin Kebbi",
  "Studio short-let in Gombe",
  "Studio short-let in Damaturu",
  "Studio short-let in Bida",
  "Studio short-let in Abakaliki",
  "Studio short-let in Abeokuta",
  "Studio short-let in Awka",
  "Studio short-let in Bwari",
  "Studio short-let in Katsina",
  "Studio short-let in Ikeja",

  // Single units that don't need city appended
  "Hotel Room",
  "Suite",
  "Penthouse short-let",
  "Resort Villa",
